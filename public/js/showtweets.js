function showTweets() {
    ...
    const tweetsContainer = document.getElementById('tweets');
      ...
      nameText.textContent = 'Elon Musk';
      ...
      usernameText.textContent = '@elonmusk';
      ...
      tweetText.textContent = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur minus deleniti veritatis obcaecati itaque laudantium beatae. Obcaecati est deserunt rem, nam quas sit facilis vel provident, porro modi nostrum voluptates necessitatibus fugit aperiam iste eius ullam dolorum non! Ullam, sint adipisci a cupiditate impedit officiis at, aliquid vitae accusantium dolores eius. Quibusdam, fugit? Illo vero molestiae sed voluptatum deleniti, impedit, labore repellendus voluptatem temporibus consectetur, corrupti tenetur omnis rem sint maiores iure. Reiciendis possimus aperiam laudantium, nihil necessitatibus dolor magnam.';
